      ...
      <header className="mk-header">
        <div className="mk-header-left">
          ...
          <nav className="mk-header-nav">
            ...
            {/* Chủ đề (Đã thêm mới) */}
            <Link to="/topics" className="mk-header-link">
              <TopicsIcon />
              <span>Chủ đề</span>
            </Link>
