...
import {
  ...
  logout,
} from "../redux/authSlice"; // 👈 lấy user + isAuth + logout
...
const BellIcon = () => (
  <svg className="mk-icon" width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path
      d="M12.0199 20.53C9.68987 20.53 7.35987 20.16 5.14987 19.42C4.30987 19.13 3.66987 18.54 3.38987 17.77C3.09987 17 3.19987 16.15 3.65987 15.39L4.80987 13.48C5.04987 13.08 5.26987 12.28 5.26987 11.81V8.92001C5.26987 5.20001 8.29987 2.17001 12.0199 2.17001C15.7399 2.17001 18.7699 5.20001 18.7699 8.92001V11.81C18.7699 12.27 18.9899 13.08 19.2299 13.49L20.3699 15.39C20.7999 16.11 20.8799 16.98 20.5899 17.77C20.2999 18.56 19.6699 19.16 18.8799 19.42C16.6799 20.16 14.3499 20.53 12.0199 20.53ZM12.0199 3.67001C9.12987 3.67001 6.76987 6.02001 6.76987 8.92001V11.81C6.76987 12.54 6.46987 13.62 6.09987 14.25L4.94987 16.16C4.72987 16.53 4.66987 16.92 4.79987 17.25C4.91987 17.59 5.21987 17.85 5.62987 17.99C9.80987 19.39 14.2399 19.39 18.4199 17.99C18.7799 17.87 19.0599 17.6 19.1899 17.24C19.3199 16.88 19.2899 16.49 19.0899 16.16L17.9399 14.25C17.5599 13.6 17.2699 12.53 17.2699 11.8V8.92001C17.2699 6.02001 14.9199 3.67001 12.0199 3.67001Z"
      fill="#292D32"
    />
    <path
...
export default function Header() {
  ...
  const handleLogout = () => {
    dispatch(logout());
    setOpen(false);
    navigate("/"); // 👈 sau này / là trang chủ
  };

  // 👇 THÊM MỚI: đi tới trang hồ sơ
  const handleGoProfile = () => {
    setOpen(false);
    navigate("/profile");
  };

  const avatarSrc = user?.avatar || "/assets/sample-avatar.jpg";
      ...
      <header className="mk-header">
        <div className="mk-header-left">
          ...
          <nav className="mk-header-nav">
            ...
            <button
              type="button"
              className="mk-header-link mk-header-link-button"
            >
              <PostsIcon />
              <span>Bài viết</span>
            </button>
            ...
            <>
              ...
              {open && (
                <div className="mk-user-menu">
                  ...
                  {/* 👇 chỉ thêm onClick, giữ nguyên UI */}
                  <button
                  ...
                  <button className="mk-user-menu-item">
                    Khóa học của tôi
                  </button>
